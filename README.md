...
Example code for connecting to an Apache Kafka cluster and authenticate with SASL/SCRAM.
...
```
git clone https://github.com/shrayjai/spring-boot-kafka-example.git
